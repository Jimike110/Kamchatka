...
export function SearchPage({ query }: SearchPageProps) {
  ...
  const performSearch = async (query: string) => {
    ...
    setIsLoading(true);
    // Mock search - in production, call your search API
        ...
        {searchQuery && (
          <div className="mb-8">
            {isLoading ? (
              ...
              <>
                <div className="mb-4">
                  <p className="text-muted-foreground">
                    {t('search.showing')} {searchResults.length} {t('search.results')} {t('search.for')} "{searchQuery}"
                  </p>
                </div>
              ...
              <div className="text-center py-8">
                <div className="text-lg mb-2">{t('search.noResults')} "{searchQuery}"</div>
                <p className="text-muted-foreground mb-4">{t('search.suggestions')}</p>
