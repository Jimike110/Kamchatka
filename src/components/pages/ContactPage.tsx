              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      info@kamchatka-adventures.com<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      ...
                      {t('contact.info.weekends')}: 10:00 - 16:00<br />
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="font-medium">{t('contact.emergency.line')}</span>
                    <span>+7 (415) 911-0000</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium">{t('contact.emergency.satellite')}</span>
