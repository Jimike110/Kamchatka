    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader>
          ...
          <SheetDescription>Review your selected adventures</SheetDescription>
        </SheetHeader>

        {/* Cart Items (scrollable area) */}
        <div className="flex-1 px-3 overflow-y-auto py-4 space-y-4">
          {loading ? (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              updateGuests(item.id, item.guests + 1)
                            }
                            className="h-6 w-6 p-0"
                          >
        ...
        {items.length > 0 && (
          <div className="border-t px-3 pt-4 space-y-4">
