      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="max-w-md mx-4 sm:mx-auto">
          <DialogHeader className="sr-only">
            ...
            <DialogDescription>{t('checkout.bookingConfirmed')}</DialogDescription>
          </DialogHeader>
          <div className="text-center py-6">
            <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
              <Check className="h-8 w-8 text-green-600 dark:text-green-400" />
            </div>
            <h2 className="text-2xl font-bold mb-2">{t('checkout.bookingConfirmed')}</h2>
              ...
              <CardContent>
                <Tabs value={paymentMethod} onValueChange={setPaymentMethod}>
                  <TabsList className="grid w-full grid-cols-3">
                    ...
                    <TabsTrigger value="crypto">{t('payment.crypto')}</TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="crypto" className="space-y-4">
                    <div className="text-center py-6">
                      <Badge className="mb-4">{t('payment.cryptoPayment')}</Badge>
                      <p className="text-sm text-muted-foreground">
              ...
              <CardContent>
                <form onSubmit={handlePayment} className="space-y-4">
                  ...
                  >
                    ...
                    {processing ? t('common.processing') : `${t('checkout.completeBooking')} - ${formatPrice(totalAmount)}`}
                  </Button>
                </form>
              </CardContent>
            </Card>
